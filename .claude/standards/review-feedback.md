...
Áp dụng cho mọi agent trong `.claude/agents/` khi đưa ra nhận xét/review về nội dung đã tồn tại (code, tài liệu, roadmap...). Không áp dụng cho phần một agent tự sáng tác nội dung mới (vd Instructional Designer khi viết bản thảo) — phần đó theo tiêu chuẩn riêng của agent đó.
...
- **Thuật ngữ chính xác** — đọc và áp dụng `.claude/standards/terminology-precision.md`.
